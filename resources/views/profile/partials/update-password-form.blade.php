    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-8 space-y-6">
        ...
        <div class="space-y-2">
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password"
                class="block w-full py-4 px-6 bg-slate-50 border-none rounded-2xl text-slate-700 font-bold focus:ring-4 focus:ring-[#D4AF37]/10"
        ...
        <div class="flex items-center gap-4 pt-4">
            <button type="submit"
                class="px-8 py-4 bg-[#D4AF37] rounded-2xl text-xs font-black text-white uppercase tracking-[0.2em] shadow-lg shadow-cyan-200 hover:bg-[#B8860B] transition-all active:scale-95">
                {{ __('Update Password') }}
            </button>
