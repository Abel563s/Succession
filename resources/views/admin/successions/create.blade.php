        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="{{ route('admin.successions.index') }}" 
                   class="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-[#00ADC5] hover:border-[#00ADC5]/20 hover:bg-[#f0fbfd] transition-all">
                    <i data-lucide="chevron-left" class="w-5 h-5"></i>
                </a>
                <div>
                    <h1 class="text-2xl font-black text-slate-900 tracking-tight">Succession Planning Nomination</h1>
                    <p class="text-slate-500 font-medium text-sm">Nominate and evaluate candidates for future leadership roles.</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.successions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-8 py-6 border-b border-slate-100 bg-slate-50/30">
                    <h2 class="text-lg font-black text-slate-800 flex items-center gap-2">
                        <span class="w-7 h-7 rounded-lg bg-[#00ADC5] text-white flex items-center justify-center text-xs">1</span>
                        Basic Information
                    </h2>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="px-8 py-6 border-b border-slate-100 bg-slate-50/30">
                    <h2 class="text-lg font-black text-slate-800 flex items-center gap-2">
                        <span class="w-7 h-7 rounded-lg bg-[#00ADC5] text-white flex items-center justify-center text-xs">2</span>
                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="core_competencies" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('core_competencies') }}</textarea>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="technical_competencies" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('technical_competencies') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="justification" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('justification') }}</textarea>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="okr_achievement" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('okr_achievement') }}</textarea>
                    </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8">
                    <div class="space-y-2">
                        <label class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Evaluation Signature (Upload Image)</label>
            ...
            <div class="flex items-center justify-end gap-3 pb-12">
                ...
                <button type="submit" 
                        class="bg-[#00ADC5] hover:bg-[#00ADC5]/90 text-white px-10 py-3 rounded-2xl font-bold transition-all shadow-lg shadow-[#00ADC5]/20 hover:scale-105 active:scale-95">
                    Submit Nomination
                </button>
            </div>
        </form>
