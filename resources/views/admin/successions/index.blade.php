            ...
            <div class="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm inline-block">
                <form action="{{ route('admin.successions.index') }}" method="GET" class="flex flex-wrap items-end justify-center gap-4">
                    ...
                    <div class="w-48 text-left">
                        ...
                        <select name="readiness_level" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:border-[#00515F] outline-none text-xs font-bold text-slate-700 appearance-none">
            ...
            <div class="overflow-x-auto custom-scrollbar">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group text-sm">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-[10px] text-slate-400 font-medium">IPG Score: <span class="text-[#00ADC5] font-black">{{ $record->ipg_score }}</span></span>
                                    </div>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="px-6 py-20 text-center text-slate-400 font-medium italic">No nomination records found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
