                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="core_competencies" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('core_competencies', $succession->core_competencies) }}</textarea>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="technical_competencies" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('technical_competencies', $succession->technical_competencies) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="justification" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('justification', $succession->justification) }}</textarea>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="okr_achievement" required rows="3"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('okr_achievement', $succession->okr_achievement) }}</textarea>
                    </div>
