                    ...
                    <div class="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden h-fit">
                        ...
                        <div class="p-8 space-y-6">
                            <div class="space-y-2">
                                ...
                                <textarea name="comments" rows="12" class="w-full px-6 py-4 bg-slate-50 border border-slate-200 focus:border-[#D4AF37] outline-none transition-all text-sm font-medium resize-none shadow-sm" placeholder="Detailed feedback on growth, performance, and recommendations...">{{ old('comments', $leadership->comments) }}</textarea>
                            </div>
                            ...
                            <div class="space-y-4 pt-6 border-t border-slate-100">
                                ...
                                <div x-data="{ preview: '{{ $leadership->signature_path ? \App\Support\StorageUrl::public($leadership->signature_path) : null }}' }" class="space-y-4">
