                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-2">
                        ...
                        <textarea name="mitigation_plan" required rows="4"
                                  ...
                                  class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] focus:ring-4 focus:ring-[#00ADC5]/10 outline-none transition-all resize-none">{{ old('mitigation_plan', $criticalRole->mitigation_plan) }}</textarea>
