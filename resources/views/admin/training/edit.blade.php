            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        ...
                        <div x-data="{ preview: '{{ $training->manager_signature ? asset('storage/' . $training->manager_signature) : null }}' }" class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div x-data="{ preview: '{{ $training->candidate_signature ? asset('storage/' . $training->candidate_signature) : null }}' }" class="space-y-4">
