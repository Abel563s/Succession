                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group text-sm">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-xl bg-[#f0fbfd] border border-[#00515F]/10 flex items-center justify-center font-black text-[#00515F]">
                                ...
                                <td class="px-6 py-5">
                                    <div class="max-w-xs">
                                        ...
                                        <div class="text-[10px] font-black text-[#00515F] uppercase tracking-wider mt-1">{{ $record->skill_area_1 }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-5">
                                ...
                                <td class="px-6 py-5 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="{{ route('admin.training.show', $record) }}" 
                                           class="w-8 h-8 rounded-lg bg-slate-100 text-slate-400 hover:text-[#00515F] hover:bg-[#f0fbfd] flex items-center justify-center transition-all"
                                           title="View Details">
