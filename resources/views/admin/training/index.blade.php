                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group text-sm">
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-xl bg-[#FFF8E7] border border-[#111111]/10 flex items-center justify-center font-black text-[#111111]">
                                ...
                                <td class="px-6 py-5 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <a href="{{ route('admin.training.show', $record) }}" 
                                           class="w-8 h-8 rounded-lg bg-slate-100 text-slate-400 hover:text-[#111111] hover:bg-[#FFF8E7] flex items-center justify-center transition-all"
                                           title="View Details">
