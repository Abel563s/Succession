    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black text-slate-900 tracking-tight">Edit Grid Evaluation</h1>
                    <p class="text-slate-500 font-medium text-sm">Update assessment for {{ $nineBox->candidate_name }}.</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.nine-box.update', $nineBox) }}" method="POST" enctype="multipart/form-data" 
              x-data="{ 
                selected: '{{ old('grid_position', $nineBox->grid_position) }}',
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    <div class="space-y-4">
                        ...
                        <div x-data="{ preview: '{{ $nineBox->signature_path ? asset('storage/' . $nineBox->signature_path) : null }}' }" class="space-y-4">
