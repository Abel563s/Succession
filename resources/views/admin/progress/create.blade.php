            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8 space-y-4">
                    <div class="space-y-2">
                        ...
                        <textarea name="performance_summary" rows="5" class="w-full px-6 py-4 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] outline-none transition-all text-sm font-medium resize-none shadow-sm" placeholder="Summarize overall development progress..."></textarea>
                    </div>
                </div>
            </div>
                            ...
                            <template x-for="(row, index) in rows" :key="index">
                                <tr class="border-b border-slate-50 hover:bg-slate-50/30 transition-colors">
                                    <td class="px-8 py-4 align-top">
                                        <input type="date" name="review_date[]" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700 outline-none focus:border-[#00ADC5] rounded-lg">
                                    </td>
                                    <td class="px-4 py-4">
                                        <textarea name="achievements[]" rows="2" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 text-xs font-medium text-slate-600 outline-none focus:border-[#00ADC5] rounded-lg resize-none shadow-sm"></textarea>
                                    </td>
                                    <td class="px-4 py-4">
                                        <textarea name="challenges[]" rows="2" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 text-xs font-medium text-slate-600 outline-none focus:border-[#00ADC5] rounded-lg resize-none shadow-sm"></textarea>
                                    </td>
                                    <td class="px-4 py-4">
                                        <textarea name="next_steps[]" rows="2" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 text-xs font-medium text-slate-600 outline-none focus:border-[#00ADC5] rounded-lg resize-none shadow-sm"></textarea>
                                    </td>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <textarea name="new_competencies" rows="4" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] outline-none transition-all text-sm font-medium resize-none shadow-sm"></textarea>
                    </div>
                    <div class="space-y-2">
                        <label class="text-[11px] font-black uppercase tracking-widest text-slate-400 ml-1">Gaps Identified</label>
                        <textarea name="gaps_identified" rows="4" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] outline-none transition-all text-sm font-medium resize-none shadow-sm"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-8 space-y-4">
                    <div class="space-y-2">
                        ...
                        <textarea name="updated_action_plan" rows="5" class="w-full px-6 py-4 bg-slate-50 border border-slate-200 focus:border-[#00ADC5] outline-none transition-all text-sm font-medium resize-none shadow-sm"></textarea>
                    </div>
                </div>
            </div>
