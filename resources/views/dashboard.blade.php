<x-app-layout>
    <div class="py-6 space-y-6">
            ...
            <div
                ...
                <div class="space-y-2">
                    <h2 class="text-3xl font-black text-slate-900 tracking-tight">
                        Welcome, <span class="text-[#D4AF37]">{{ Auth::user()->name }}</span>
                    </h2>
        ...
        <div class="flex flex-col items-center justify-center py-20 px-4 text-center">
            <div class="w-20 h-20 bg-[#FFF8E7] rounded-full flex items-center justify-center mb-6 border border-[#D4AF37]/10">
                <i data-lucide="layout-dashboard" class="w-10 h-10 text-[#D4AF37]"></i>
            </div>
