...
<div
    ...
    style="display: {{ $show ? 'block' : 'none' }}; position: fixed !important; z-index: 100000 !important;"
>
    <div
        x-show="show"
    ...
    >
        <div class="absolute inset-0 modal-overlay" style="z-index: 99998 !important;"></div>
    </div>
