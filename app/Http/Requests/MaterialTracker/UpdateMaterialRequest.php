...
class UpdateMaterialRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'discipline' => ['sometimes', 'required', 'in:Civil,MEP'],
            'procurement_product' => ['sometimes', 'required', 'in:Material,Service'],
            'supply_route' => ['sometimes', 'required', 'in:Import,Local'],
            'approval' => ['boolean'],
            'procurement_type' => ['sometimes', 'required', 'in:LVA,RFQ-Local,RFQ-Import-Birr,RFQ-Import-USD,IFB-ICB,IFB-NCB,RFP,LTA'],
